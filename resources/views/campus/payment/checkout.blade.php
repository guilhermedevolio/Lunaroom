            ...
            <div class="row mt-3 ">
                ...
                <div class="col-md-8 shadow-lg p-3 mb-5 bg-white rounded">
                    <div class="row formas-pagto">
                        <div class="card forma-pagto-card shadow-lg  bg-white rounded " method="pix"
                        ...
                        <div class="card shadow-lg forma-pagto-card bg-white rounded" method="ccr"
                             style="width: 15rem; margin-left: 5px; cursor: pointer;">
                            <div class="card-body d-flex justify-content-center align-items-center flex-column">
                                <img width="160"
                                     src="https://i.pinimg.com/originals/51/ba/5c/51ba5cf6a6cf2477e29601662b584818.png"
                                     alt="">
                    ...
                    <div class="pix_method methods-payment" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="pix-rigth  col-md-6">
                                ...
                                <p>Após finalizar a compra será gerado um QRCode, realize o pagamento por seu banco de
                                    preferência</p>
                            </div>
                        </div>
                        <div class="btn btn-success w-100 mt-3 btn-exec-payment" onclick="processPayment()">Continuar
                        </div>
                        <button id="btn-loading" style="display: none" class="btn btn-primary w-100" type="button"
                                disabled>
                    ...
                    <div class="ccr_method methods-payment" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <form id="form-checkout">
                                ...
                                <input type="text" class="form-control mb-2" name="cardNumber"
                                       id="form-checkout__cardNumber"/>
                                <label class="form-label">Data de Vencimento</label>
                                <input type="text" class="form-control mb-2" name="cardExpirationDate"
                                       id="form-checkout__cardExpirationDate"/>
                                <label class="form-label">Titular do Cartão</label>
                                <input type="text" class="form-control mb-2" name="cardholderName"
                                       id="form-checkout__cardholderName"/>
                                <label class="form-label">Titular do Cartão</label>
                                <input type="email" class="form-control mb-2" name="cardholderEmail"
                                       id="form-checkout__cardholderEmail"/>
                                <label class="form-label">CVV</label>
                                <input type="text" class="form-control mb-2" name="securityCode"
                                ...
                                <select name="identificationType" class="form-control mb-2"
                                        id="form-checkout__identificationType"></select>
                                <label class="form-label">Documento</label>
                                <input type="text" class="form-control mb-2" name="identificationNumber"
                                       id="form-checkout__identificationNumber"/>
                                <label class="form-label">Parcelas</label>
                                <select name="installments" class="form-control mb-2"
                                        id="form-checkout__installments"></select>
                                <button type="submit" class="form-control btn-success" id="form-checkout__submit">
                                    Pagar
                                </button>
                            </form>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="shadow-lg p-3 mb-5 bg-white rounded">
                        ...
                        <div class="alert alert-success">
                            <h1>R$ {{ number_format($totalCartValue, 2) }}</h1>
                        </div>
                    </div>
                </div>
